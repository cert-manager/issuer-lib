...
func TestCertificateSigningRequestReconcilerReconcile(t *testing.T) {
	...
	tests := []testCase{
		...
		// the MaxRetryDuration has been exceeded).
		{
			...
			sign: func(_ context.Context, _ signer.CertificateRequestObject, _ v1alpha1.Issuer) (signer.PEMBundle, signer.ExtraConditions, error) {
				return signer.PEMBundle{}, signer.ExtraConditions{}, signer.PendingError{Err: fmt.Errorf("pending error")}
			},
			objects: []client.Object{
				cmgen.CertificateSigningRequestFrom(cr1,
					func(cr *certificatesv1.CertificateSigningRequest) {
		...
		// the MaxRetryDuration has been exceeded).
		{
			...
			sign: func(_ context.Context, cr signer.CertificateRequestObject, _ v1alpha1.Issuer) (signer.PEMBundle, signer.ExtraConditions, error) {
				return signer.PEMBundle{}, nil, signer.PendingError{Err: fmt.Errorf("pending error"), RequeueAfter: 5 * time.Second}
			},
			objects: []client.Object{
				cmgen.CertificateSigningRequestFrom(cr1,
					func(cr *certificatesv1.CertificateSigningRequest) {
