...
func (f *Framework) WaitForKubeNamespaceNotExist(pollCtx context.Context, namespace string) error {
	return wait.PollUntilContextTimeout(pollCtx, Poll, time.Minute*2, true, func(ctx context.Context) (bool, error) {
