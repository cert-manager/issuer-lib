...
func (Signer) Sign(ctx context.Context, cr signer.CertificateRequestObject, issuerObject v1alpha1.Issuer) signer.SignResult {
	...
	return signer.SignSuccess(clientCrt)
}
